 ...
 * tab previews truncate from the right, and "Analytics" after `Omagraph · `
 * used to be cut mid-word ("Omagraph · Anal…"). The full tagline lives in the
 * description and og:image, which don't truncate.
 */
export const SITE_TITLE = "Omagraph · Omarchy plugin stats";
